...
angular.module('starter', ['ionic', 'starter.controllers', 'starter.directives' , 'starter.services', 'angular.filter', 'angularMoment', 'firebase', 'jett.ionic.filter.bar', 'ngCordova'])
